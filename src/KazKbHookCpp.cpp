// KazKbHookCpp.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "KazKbHookCpp.h"
#include "keymapper.h"
#include "maindlg.h"
                     ...
                     int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_KAZKBHOOKCPP, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_KAZKBHOOKCPP));
                          ...
                          LPARAM lParam)
{
	...
	case WM_INPUT:
		...
		break;
    case WM_INITDIALOG:
		SetIcon(hInst, hwnd, IDI_KAZKBHOOKCPP);
        return TRUE;
		break;
    case WM_COMMAND:
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_KAZKBHOOKCPP));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_KAZKBHOOKCPP);
